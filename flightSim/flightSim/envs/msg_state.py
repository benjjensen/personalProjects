...
class msg_state:
    ...
    def tolist(self):
        return np.array([self.pn, self.pe, self.h, self.phi, self.theta, self.psi, self.Va, self.alpha, self.beta,\
                            self.p, self.q, self.r, self.Vg, self.gamma, self.chi, self.wn, self.we, self.bx, self.by, self.bz])